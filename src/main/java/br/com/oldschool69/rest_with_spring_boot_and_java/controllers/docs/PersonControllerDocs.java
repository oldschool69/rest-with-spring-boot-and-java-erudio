...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Export people",
            description = "Export a page of People in xlsx and csc format",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success",
                            responseCode = "200",
    ...
    @Operation(summary = "Massive people creation",
            description = "Massive people creation with XLSX or CSV file upload",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success",
                            responseCode = "200",
    ...
    List<PersonDTO> createMany(MultipartFile file);
